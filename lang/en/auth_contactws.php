...
$string['errorauthuserstatus'] = 'User does not have active status in SARH';
$string['errorauthidnumbermismatch'] = 'Moodle identification number does not match SARH document number';
