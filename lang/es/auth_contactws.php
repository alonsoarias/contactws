...
$string['errorauthuserstatus'] = 'El usuario no tiene estado activo en SARH';
$string['errorauthidnumbermismatch'] = 'El número de identificación en Moodle no coincide con el número de documento en SARH';
